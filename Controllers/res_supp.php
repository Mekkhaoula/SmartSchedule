<?php
    ...
    mysqli_select_db($conn,"pfe");
             $message="la demande de reservation de ".$tab["as"]."/".$tab["location"]."le".$tab["day"]. " a etait annuler";
		     $reqpr = mysqli_prepare($conn,"INSERT INTO notification value('".$tab['user']."','$message','$actual','false','reservation annuler','$email')");
